...
import Settings from '@/components/founder-space/interfaces/people.vue';
...
<template>
    ...
    <div v-if="mobileMode">
        <div class="burgerContainer-top" v-if="mobileMode">
            <img class="settings-top" style="z-index:9999" src="https://static.thenounproject.com/png/1777842-200.png" @click="toolBarSelected=!toolBarSelected"/>
        </div>
