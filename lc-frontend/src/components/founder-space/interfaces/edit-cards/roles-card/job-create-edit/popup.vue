...
<template>
    <div @click.self="closePopup" id="popup-backdrop" class="popup-backdrop" :style="mobileView? 'width: calc(100% - 55px); left:55px;' : 'width: calc(100% ); left:0;' ">
        <div class="popup">
            <div class="header">
                <div class="buttons">
            ...
            <div class="popup-white-background" :style="{background: props.jobInformation.color.backgroundColor[0], color: props.jobInformation.color.textColor[0]}">
                <div :class="tab[0] != 4 ? 'container' : 'preview-container'">
                    <jobDescriptionTab v-if="tab[0]==1" :jobInformation="jobInformation" :tab="tab"/>
                    <JobQuestionCreationTab v-if="tab[0]==2" :jobInformation="jobInformation" :tab="tab"/>
                    <JobColorTab v-if="tab[0]==3" :jobInformation="jobInformation" :tab="tab"/>
                    <JobPreview v-if="tab[0]==4" :jobInformation="jobInformation" :tab="tab" :jobs="jobs" :renderVar="renderVar" :newJob="newJob"/>
                    <JobSettingsTab v-if="tab[0]==5" :jobInformation="jobInformation" :tab="tab" :renderVar="renderVar" :job_id="props.job_id"/>
                </div>
            </div>
        </div>
    </div> 
