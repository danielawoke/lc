...
import JobCardMiniView from '@/components/founder-space/interfaces/edit-cards/color-change/mini-views/job-card-mini-view.vue';
...
onMounted (async () => {
    await nextTick();
    colorToPosition(props.color.backgroundColor[0]);
    ...
    document.getElementById("color-wheel").style.backgroundColor = props.color.backgroundColor[0];
    document.getElementById("hex-input").value = props.color.backgroundColor[0];
    document.getElementById("color-wheel-container").addEventListener("mousedown", (event) => {
        ...
        if(currentColor[3] === "background"){
            props.color.backgroundColor[0] = rgbColor;
        }else if(currentColor[3] === "text"){
            props.color.textColor[0] = rgbColor;
        }else if(currentColor[3] === "card"){
            props.color.jobCardColor[0] = rgbColor;
        }
        document.getElementsByClassName("color-wheel-selector")[0].style.border = "5px solid " + w3color(currentColor[0]+", 0%, 0%").toRgbString();
    ...
    document.getElementById("BW-wheel-container").addEventListener("mousedown", (event) => {
        ...
        if(currentColor[3] === "background"){
            props.color.backgroundColor[0] = color;
        }else if(currentColor[3] === "text"){
            props.color.textColor[0] = color;
        }else if(currentColor[3] === "card"){
            props.color.jobCardColor[0] = color;
        }
...
function switchTab(event){
    ...
    if(event.target.id === "job-background-color"){
        ...
        colorToPosition(props.color.backgroundColor[0]);
        document.getElementsByClassName("preview")[0].style.backgroundColor = props.color.backgroundColor[0];
        document.getElementsByClassName("color-wheel-selector")[0].style.border = "5px solid " + w3color(currentColor[0]+", 0%, 0%").toRgbString();
        document.getElementById("color-wheel").style.backgroundColor = props.color.backgroundColor[0];
        document.getElementById("hex-input").value = props.color.backgroundColor[0];
    }else if(event.target.id === "job-card-color"){
        currentColor[3] = "card";
        colorToPosition(props.color.jobCardColor[0]);
        document.getElementsByClassName("preview")[0].style.backgroundColor = props.color.jobCardColor[0];
        document.getElementsByClassName("color-wheel-selector")[0].style.border = "5px solid " + w3color(currentColor[0]+", 0%, 0%").toRgbString();
        document.getElementById("color-wheel").style.backgroundColor = props.color.jobCardColor[0];
        document.getElementById("hex-input").value = props.color.jobCardColor[0];
    }else if(event.target.id === "job-text-color"){
        currentColor[3] = "text";
        colorToPosition(props.color.textColor[0]);
        document.getElementsByClassName("preview")[0].style.backgroundColor = props.color.textColor[0];
        document.getElementsByClassName("color-wheel-selector")[0].style.border = "5px solid " + w3color(currentColor[0]+", 0%, 0%").toRgbString();
        document.getElementById("color-wheel").style.backgroundColor = props.color.textColor[0];
        document.getElementById("hex-input").value = props.color.textColor[0];
    }
