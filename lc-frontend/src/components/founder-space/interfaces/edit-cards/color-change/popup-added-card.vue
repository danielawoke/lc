...
import AddedCardMiniView from '@/components/founder-space/interfaces/edit-cards/color-change/mini-views/added-card-mini-view.vue';
...
onMounted (async () => {
    await nextTick();
    console.log("Card info on color change popup mount:", props.cardInfo);
    colorToPosition(props.cardInfo.backgroundColor[0]);
    ...
    document.getElementById("color-wheel").style.backgroundColor = props.cardInfo.backgroundColor[0];
    document.getElementById("hex-input").value = props.cardInfo.backgroundColor[0];
    document.getElementById("color-wheel-container").addEventListener("mousedown", (event) => {
        ...
        if(currentColor[3] === "background"){
            props.cardInfo.backgroundColor[0] = rgbColor;
        }else if(currentColor[3] === "text"){
            props.cardInfo.textColor[0] = rgbColor;
        }else if(currentColor[3] === "card"){
            props.cardInfo.headerColor[0] = rgbColor;
        }
        document.getElementsByClassName("color-wheel-selector")[0].style.border = "5px solid " + w3color(currentColor[0]+", 0%, 0%").toRgbString();
    ...
    document.getElementById("BW-wheel-container").addEventListener("mousedown", (event) => {
        ...
        if(currentColor[3] === "background"){
            props.cardInfo.backgroundColor[0] = color;
        }else if(currentColor[3] === "text"){
            props.cardInfo.textColor[0] = color;
        }else if(currentColor[3] === "card"){
            props.cardInfo.headerColor[0] = color;
        }
...
function switchTab(event){
    ...
    if(event.target.id === "job-background-color"){
        ...
        colorToPosition(props.cardInfo.backgroundColor[0]);
        document.getElementsByClassName("preview")[0].style.backgroundColor = props.cardInfo.backgroundColor[0];
        document.getElementsByClassName("color-wheel-selector")[0].style.border = "5px solid " + w3color(currentColor[0]+", 0%, 0%").toRgbString();
        document.getElementById("color-wheel").style.backgroundColor = props.cardInfo.backgroundColor[0];
        document.getElementById("hex-input").value = props.cardInfo.backgroundColor[0];
    }else if(event.target.id === "job-card-color"){
        currentColor[3] = "card";
        colorToPosition(props.cardInfo.headerColor[0]);
        document.getElementsByClassName("preview")[0].style.backgroundColor = props.cardInfo.headerColor[0];
        document.getElementsByClassName("color-wheel-selector")[0].style.border = "5px solid " + w3color(currentColor[0]+", 0%, 0%").toRgbString();
        document.getElementById("color-wheel").style.backgroundColor = props.cardInfo.headerColor[0];
        document.getElementById("hex-input").value = props.cardInfo.headerColor[0];
    }else if(event.target.id === "job-text-color"){
        currentColor[3] = "text";
        colorToPosition(props.cardInfo.textColor[0]);
        document.getElementsByClassName("preview")[0].style.backgroundColor = props.cardInfo.textColor[0];
        document.getElementsByClassName("color-wheel-selector")[0].style.border = "5px solid " + w3color(currentColor[0]+", 0%, 0%").toRgbString();
        document.getElementById("color-wheel").style.backgroundColor = props.cardInfo.textColor[0];
        document.getElementById("hex-input").value = props.cardInfo.textColor[0];
    }
...
function mobileModeListener(){
    mobileMode.value = window.innerWidth <= 1000;
                        ...
                        <div id="color-wheel-container" class="color-wheel-container">
                            ...
                            <div class="preview">
                                <div class="preview-container">
                                    <AddedCardMiniView :cardInfo="props.cardInfo"/>
                                </div>
