...
<template>
    <div class="application-box">
        <div style="color:black; margin-bottom:20px;">Provide explanation for rejection</div>
        <div style="color:black; margin-bottom:20px;">Many people would feel at ease if you provided even a brief explanation for rejecting them. We provide the space bellow, please provide an explaination for the rejection. This is optional but highly encouraged.</div>
        <textarea class="context-textarea" id="rejection-reason-text" placeholder="Leave blank for no explanation" ></textarea>
    </div>
</template>
