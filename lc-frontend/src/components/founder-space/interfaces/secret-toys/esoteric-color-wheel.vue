...
onMounted (async () => {
    ...
    document.getElementsByClassName("color-wheel-2-selector")[0].style.left = (pos.x) + "%";
    document.getElementsByClassName("color-wheel-2-selector")[0].style.top = (pos.y) + "%";
    document.getElementsByClassName("color-wheel-2-selector")[0].style.border = "5px solid " + props.color[0];

    document.getElementById("color-wheel-2-container-2-2").addEventListener("mousedown", (event) => {
        let selector = document.getElementsByClassName("color-wheel-2-selector")[0];
        ...
        document.getElementsByClassName("color-wheel-2-selector")[0].style.border = "5px solid " + color;
        document.getElementById("color-wheel-2-container-2-2").addEventListener("mousemove", colorWheelEventListener);
    });

    document.getElementById("color-wheel-2-container-2-2").addEventListener("mouseup", (event) => {
        document.getElementById("color-wheel-2-container-2-2").removeEventListener("mousemove", colorWheelEventListener);
    });
});
...
function colorWheelEventListener(event){
    ...
    document.getElementsByClassName("color-wheel-2-selector")[0].style.border = "5px solid " + rgbColor;
    document.getElementsByClassName("color-wheel-2")[0].style.backgroundColor = rgbColor;
...
<template>
    ...
    <div class="container-2">
        <div id="color-wheel-2-container-2-2" class="color-wheel-2-container-2-2">
            <img id="color-wheel-2" class="color-wheel-2" src="@/assets/founder-space/edit/color-pop-up/color-wheel.png" />
            <div class="color-wheel-2-selector"></div>
            <img class="BW-wheel-2" src="@/assets/founder-space/edit/color-pop-up/BW-wheel.png" />
